...
import (
	...
	"github.com/log-monitoring/alert-engine/internal/api/mocks"
...
func TestHandlers_GetRuleStats(t *testing.T) {
	router, _, mockEngine := setupTestRouter()

	t.Run("get rule stats success", func(t *testing.T) {
		// Mock some rules
		mockRules := []models.AlertRule{
			{ID: "rule1", Name: "Test Rule 1", Enabled: true},
			{ID: "rule2", Name: "Test Rule 2", Enabled: false},
		}
		mockEngine.SetRules(mockRules)

		req, _ := http.NewRequest("GET", "/api/v1/rules/stats", nil)
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
...
func TestHandlers_GetRuleTemplate(t *testing.T) {
	...
	t.Run("get rule template success", func(t *testing.T) {
...
func TestHandlers_GetDefaultRules(t *testing.T) {
	router, _, _ := setupTestRouter()

	t.Run("get default rules success", func(t *testing.T) {
		req, _ := http.NewRequest("GET", "/api/v1/rules/defaults", nil)
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
...
func TestHandlers_BulkCreateRules(t *testing.T) {
	router, _, _ := setupTestRouter()

	t.Run("bulk create rules success", func(t *testing.T) {
		rules := []models.AlertRule{
			{
				ID:          "bulk-rule-1",
				Name:        "Bulk Rule 1",
				Description: "Test bulk rule 1",
				Enabled:     true,
				Conditions: models.AlertConditions{
					LogLevel:   "ERROR",
					Threshold:  5,
		...
		req, _ := http.NewRequest("POST", "/api/v1/rules/bulk", bytes.NewBuffer(jsonData))
		req.Header.Set("Content-Type", "application/json")
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
	...
	t.Run("bulk create rules invalid JSON", func(t *testing.T) {
		req, _ := http.NewRequest("POST", "/api/v1/rules/bulk", bytes.NewBuffer([]byte("invalid json")))
		req.Header.Set("Content-Type", "application/json")
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
...
func TestHandlers_ReloadRules(t *testing.T) {
	...
	t.Run("reload rules success", func(t *testing.T) {
		mockEngine.SetReloadError(nil)
	...
	t.Run("reload rules error", func(t *testing.T) {
		mockEngine.SetReloadError(fmt.Errorf("reload failed"))
...
func TestHandlers_TestRule(t *testing.T) {
	router, _, _ := setupTestRouter()

	t.Run("test rule success", func(t *testing.T) {
		testRequest := map[string]interface{}{
			"rule": models.AlertRule{
				ID:          "test-rule-for-testing",
				Name:        "Test Rule",
		...
		req, _ := http.NewRequest("POST", "/api/v1/rules/test", bytes.NewBuffer(jsonData))
		req.Header.Set("Content-Type", "application/json")
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
	...
	t.Run("test rule invalid JSON", func(t *testing.T) {
		req, _ := http.NewRequest("POST", "/api/v1/rules/test", bytes.NewBuffer([]byte("invalid json")))
		req.Header.Set("Content-Type", "application/json")
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
...
func TestHandlers_FilterRules(t *testing.T) {
	router, _, mockEngine := setupTestRouter()

	t.Run("filter rules success", func(t *testing.T) {
		// Mock some rules
		mockRules := []models.AlertRule{
			{ID: "rule1", Name: "Test Rule 1", Enabled: true},
			{ID: "rule2", Name: "Test Rule 2", Enabled: false},
		...
		req, _ := http.NewRequest("POST", "/api/v1/rules/filter", bytes.NewBuffer(jsonData))
		req.Header.Set("Content-Type", "application/json")
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
	...
	t.Run("filter rules invalid JSON", func(t *testing.T) {
		req, _ := http.NewRequest("POST", "/api/v1/rules/filter", bytes.NewBuffer([]byte("invalid json")))
		req.Header.Set("Content-Type", "application/json")
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
