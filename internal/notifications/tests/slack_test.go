...
import (
	...
	"github.com/log-monitoring/alert-engine/internal/notifications/tests/mocks"
...
func TestSlackNotifier_CreateAlertSummary(t *testing.T) {
	...
	t.Run("handles empty alert list", func(t *testing.T) {
		...
		assert.Equal(t, notifications.SlackMessage{}, summary)
	})
}
...
func TestSlackNotifier_GetSeverityEmoji(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(fmt.Sprintf("severity_%s", tt.severity), func(t *testing.T) {
			emoji := notifications.GetSeverityEmoji(tt.severity)
...
func TestSlackNotifier_GetSeverityColor(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(fmt.Sprintf("severity_%s", tt.severity), func(t *testing.T) {
			color := notifications.GetSeverityColor(tt.severity)
...
func TestSlackMessage_JSONMarshaling(t *testing.T) {
	t.Run("marshals and unmarshals slack message", func(t *testing.T) {
		originalMessage := notifications.SlackMessage{
			Channel:   "#test",
			Username:  "Test Bot",
			...
			Attachments: []notifications.SlackAttachment{
				{
					...
					Title: "Test Alert",
					Text:  "This is a test",
					Fields: []notifications.SlackField{
						{
							Title: "Status",
							Value: "Critical",
							Short: true,
		...
		// Unmarshal back
		var unmarshaledMessage notifications.SlackMessage
