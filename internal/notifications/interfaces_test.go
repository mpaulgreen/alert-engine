...
func TestNotificationChannel(t *testing.T) {
	...
	t.Run("marshals and unmarshals notification channel", func(t *testing.T) {
		...
		// Unmarshal back
		var unmarshaledChannel NotificationChannel
...
func TestNotificationTemplate(t *testing.T) {
	...
	t.Run("marshals and unmarshals notification template", func(t *testing.T) {
		...
		// Unmarshal back
		var unmarshaledTemplate NotificationTemplate
...
func TestNotificationResult(t *testing.T) {
	...
	t.Run("marshals and unmarshals notification result", func(t *testing.T) {
		originalResult := NotificationResult{
			ID:        "result-003",
			AlertID:   "alert-003",
			Channel:   "email-dev",
			Status:    "pending",
...
func TestNotificationHistory(t *testing.T) {
	...
	t.Run("marshals and unmarshals notification history", func(t *testing.T) {
		originalHistory := NotificationHistory{
			AlertID: "alert-002",
			RuleID:  "rule-002",
			Results: []NotificationResult{
				{
		...
		// Unmarshal back
		var unmarshaledHistory NotificationHistory
...
func TestNotificationStats(t *testing.T) {
	...
	t.Run("marshals and unmarshals notification stats", func(t *testing.T) {
		originalStats := NotificationStats{
		...
		// Unmarshal back
		var unmarshaledStats NotificationStats
...
func TestNotificationConfig(t *testing.T) {
	...
	t.Run("marshals and unmarshals notification config", func(t *testing.T) {
		...
		// Unmarshal back
		var unmarshaledConfig NotificationConfig
...
func TestNotificationFilter(t *testing.T) {
	...
	t.Run("marshals and unmarshals notification filter", func(t *testing.T) {
		originalFilter := NotificationFilter{
		...
		// Unmarshal back
		var unmarshaledFilter NotificationFilter
...
func TestTimeRange(t *testing.T) {
	...
	t.Run("marshals and unmarshals time range", func(t *testing.T) {
		...
		// Unmarshal back
		var unmarshaledTimeRange TimeRange
...
// TestGlobalNotificationConfig tests global configuration management
func TestGlobalNotificationConfig(t *testing.T) {
	t.Run("sets and gets global notification config", func(t *testing.T) {
		originalConfig := GetGlobalNotificationConfig()

		newConfig := NotificationGlobalConfig{
		...
		SetGlobalNotificationConfig(newConfig)
		retrievedConfig := GetGlobalNotificationConfig()

		assert.Equal(t, newConfig.SeverityEmojis, retrievedConfig.SeverityEmojis)
		assert.Equal(t, newConfig.SeverityColors, retrievedConfig.SeverityColors)

		// Test emoji function with new config
		assert.Equal(t, "🔥", GetSeverityEmoji("critical"))
		assert.Equal(t, "#FF0000", GetSeverityColor("critical"))

		// Restore original config
		SetGlobalNotificationConfig(originalConfig)
	})

	t.Run("gets default values for unknown severities", func(t *testing.T) {
		emoji := GetSeverityEmoji("unknown-severity")
		color := GetSeverityColor("unknown-severity")
